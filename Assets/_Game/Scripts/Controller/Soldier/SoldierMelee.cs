...
{
    public class SoldierMelee : SoldierBase , IPoolable<int,UnitTeams,SoldierTypes,IMemoryPool>
    {
        ...
        public class Factory : PlaceholderFactory<int, UnitTeams, SoldierTypes, SoldierMelee>
        {
